...
if n <= 4 * 9:
    print(f'Flat: {n} is on the entrance 1, floor: {ceil(n / 4)}')
elif 4 * 9 < n <= 4 * 9 * 2:
    print(f'Flat: {n} is on the entrance 2, floor: {ceil(n / 4) - 9}')
elif 4 * 9 * 2 < n <= 4 * 9 * 3:
    print(f'Flat: {n} is on the entrance 3, floor: {ceil(n / 4) - 18}')
elif 4 * 9 * 3 < n <= 4 * 9 * 4:
    print(f'Flat: {n} is on the entrance 4, floor: {ceil(n / 4) - 27}')
else:
